...
<form className={style.goalForm}>
  <div className="mb-3">
    ...
    <input type="text" className="form-control" id="name"   value={inputValue}   aria-describedby="emailHelp"
  ...
  <div className="mb-3">
    ...
    <input type="date" className="form-control" id="deadline"  value={deadline}
